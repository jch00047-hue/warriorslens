...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    items: [
      "Theater messaging",
      "Press / engagement support",
      "Joint & multinational PA",
...
export const CHARGERS = {
  ...
  body: [
    "It’s September 2021 — FedExField, Landover, Maryland. My favorite team opens the season against Washington. As a photographer first and fan second, I documented the atmosphere, the plays, and the moment that would define both teams' year: Ryan Fitzpatrick's hip injury in the second quarter.",
  ...
  images: [
    `${CHARGERS_BASE}/DSC_0414.jpg`,
    `${CHARGERS_BASE}/DSC_0415.jpg`,
    `${CHARGERS_BASE}/DSC_0430.jpg`,
    `${CHARGERS_BASE}/DSC_0443.jpg`,
    `${CHARGERS_BASE}/DSC_0486.jpg`,
    `${CHARGERS_BASE}/DSC_0498.jpg`,
    `${CHARGERS_BASE}/DSC_0613.jpg`,
    `${CHARGERS_BASE}/DSC_0697.jpg`,
    `${CHARGERS_BASE}/DSC_0712.jpg`,
    `${CHARGERS_BASE}/DSC_0729.jpg`,
    `${CHARGERS_BASE}/DSC_0746.jpg`,
    `${CHARGERS_BASE}/DSC_0756.jpg`,
    `${CHARGERS_BASE}/DSC_0769.jpg`,
    `${CHARGERS_BASE}/DSC_0805.jpg`,
    `${CHARGERS_BASE}/DSC_0848.jpg`,
    `${CHARGERS_BASE}/DSC_0964.jpg`,
    `${CHARGERS_BASE}/DSC_0998.jpg`,
  ],
  hero: `${CHARGERS_BASE}/DSC_0414.jpg`,
};
