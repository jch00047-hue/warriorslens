...
export const ABOUT = {
  ...
  body: [
    ...
    "In 2020 I realigned with my real passion: visual storytelling. I attended the Mass Communications Foundations Course and the Graphic Design Course at DINFOS, then joined the 55th Signal Company (Combat Camera).",
    "I deployed to Iraq and Syria as Combat Camera Team Lead for CJTF–Operation Inherent Resolve, and most recently served as Combat Camera Team Lead for Navy Central Command (NAVCENT) Public Affairs."
  ],
  highlights: [
...
// Projects — DVIDS public domain imagery (cloudfront thumbnails)
const D = (yymm, id) =>
...
export const EXPERIENCE = [
  {
    ...
    body: "Led joint Combat Camera support across Army, Navy, and Air Force PA elements. Documented multinational maritime operations, exercises, and command-level engagements throughout the Combined Maritime Forces area of operations."
  },
  {
    year: "2022 — 2023",
    ...
    location: "Iraq / Syria",
    body: "Led Combat Camera teams in support of theater-level Public Affairs themes and messages. Planned and executed visual documentation aligned with operational objectives and coalition messaging across CENTCOM AOR."
  },
  {
    year: "2021 — 2022",
    ...
    location: "Fort Meade, MD",
    body: "Led a Combat Camera squad and served as company Webmaster — redesigned the AFPIMS site, streamlined mission support, and supported JPMRC 1–22 in Honolulu, Hawaii."
  },
  {
    year: "2020",
  ...
  },
  {
    ...
    body: "Mobilized in support of national defense operations along the southern border. Augmented patrol and force-protection missions — the assignment that sharpened my eye for documentation in the field."
  },
  {
    year: "2017 — 2019",
...
// Featured volunteer project — real imagery & description from the Wix portfolio
const wix = (slug) =>
...
export const VOLUNTEER = {
  ...
  body: [
    "As a dedicated parent volunteer, I support Pursuing Hill Elementary by documenting major school ceremonies and events. This was a special initiative to bring fresh, vibrant visuals to the school's interior spaces.",
  ...
  // Real photographs from the Pursuing Hill Elementary project (Wix CDN)
  images: [
